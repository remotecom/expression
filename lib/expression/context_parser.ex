defmodule Expression.ContextParser do
  @moduledoc """
  Expression.ContextParser is responsible for accepting a string
  ...
  # Example
    ...
    iex(1)> Expression.ContextParser.parse("hello @world")
